            ...
            watch: {
                ...
                currentStore: function () {
                    ...
                    if (_.includes(categories, delivery_category) && !_.isEmpty(subcategories)) {
                        ...
                        if (_.includes(subcategories, 8927)) {
                            this.hasUberEats = true;
                        }
                        if (_.includes(subcategories, 8924)) {
                            this.hasDoordash = true;
                        }
                        if (_.includes(subcategories, 8928)) {
                            this.hasGrubhub = true;
                        }
                        if (_.includes(subcategories, 8925)) {
                            this.hasPostmates = true;   
                        }
                        if (_.includes(subcategories, 8926)) {
                    ...
                    _.forEach(this.currentStore.promotions, function(value, key) {
                        ...
                        if (_.includes(current_promo.image_url, 'missing')) {
                            current_promo.image_url = "//codecloud.cdn.speedyrails.net/sites/5b6dcf4e6e6f647b570a0000/image/png/1529532181000/promoplaceholder2@2x.png";
                        }
                    ...
                    _.forEach(this.currentStore.events, function(value, key) {
                        ...
                        if (_.includes(current_event.image_url, 'missing')) {
                            current_event.image_url = "//codecloud.cdn.speedyrails.net/sites/5b6dcf4e6e6f647b570a0000/image/png/1529532187000/eventsplaceholder2@2x.png";
                        }
