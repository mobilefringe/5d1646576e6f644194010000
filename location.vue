            ...
            <div v-if="dataLoaded" v-cloak>
                ...
                <div class="main_container">
                    ...
                    <div class="location_map">
                        ...
                        <iframe aria-hidden="true" :title="'Google Map for ' + property.name" :src="propertyAddress2()" width="100%" height="490" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="main_container">
                    <div class="row">
