    ...
    <div> <!-- for some reason if you do not put an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <div class="inside_page_header" v-bind:style="{ background: 'linear-gradient(0deg, rgba(0,0,0,0.2), rgba(0,0,0,0.2)), url(' + pageBanner.image_url + ') center center #3176b8' }">
                ...
                <div class="main_container">
                    ...
                    <div class="location_map">
                        <iframe :src="propertyAddress2()" width="100%" height="490" frameborder="0" style="border:0" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="main_container">
                    <div class="row">
		...
		return Vue.component("location-component", {
            ...
            methods: {
                loadData: async function () {
                    ...
                    try {
                        let results = await Promise.all([this.$store.dispatch("getData", "repos"), this.$store.dispatch('LOAD_PAGE_DATA', {url: this.property.mm_host + "/pages/vistavillage-location.json"})]);
                        return results;
                    } catch (e) {
                ...
                propertyAddress2() {
                    var address = this.property.name + "+225 – 401 Vista Village Drive+Vista+CA+92084+" + this.property.country
                    var key ="AIzaSyCukCjH3fsuDYBdI44hZKL43m60jEToJjY"
                    var src = "https://www.google.com/maps/embed/v1/place?q=" + address + "&key="+ key
                    return src
                }
